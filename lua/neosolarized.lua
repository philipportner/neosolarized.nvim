...
function M.setup(opts)
	...
	Group.new("NeogitDiffAddHighlight", colors.blue, colors.none)
	Group.new("NeogitDiffDeleteHighlight", colors.blue, colors.none)
	Group.new("NeogitHunkHeader", groups.Normal, colors.none)
	Group.new("NeogitHunkHeaderHighlight", groups.Normal, colors.none)
	Group.new("NeogitDiffContextHighlight", colors.base2, colors.none)
